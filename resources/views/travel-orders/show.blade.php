                        ...
                        <div class="flex items-center gap-4 mb-8 pb-8 border-b border-gray-50">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    @if($travelOrder->employee->position)
                                        <p class="text-gray-400 font-bold uppercase tracking-widest text-[10px]">{{ $travelOrder->employee->position }}</p>
                                    @endif
                                    @php
                                        $typeColors = [
                ...
                <div class="space-y-8">
                    @if($isApprover && $travelOrder->attachment_path)
                        <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                            ...
                            <a href="{{ asset('storage/' . $travelOrder->attachment_path) }}" target="_blank" class="mt-4 mx-auto h-10 w-10 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all shadow-md hover:-translate-y-0.5 flex items-center justify-center" title="{{ __('View Attachment') }}" aria-label="{{ __('View Attachment') }}">
