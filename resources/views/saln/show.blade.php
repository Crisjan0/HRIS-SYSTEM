        ...
        <div class="max-w-[900px] mx-auto sm:px-6 lg:px-8 print:max-w-none print:mx-0 print:px-0">
            <div class="saln-actions mb-4 flex items-center justify-between gap-3 font-sans print:hidden">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('salns.download', $saln) }}" data-no-transition class="rounded-lg bg-gray-800 px-5 py-2.5 text-xs font-black uppercase tracking-widest text-white hover:bg-gray-700">Download SALN</a>
                </div>
            </div>
